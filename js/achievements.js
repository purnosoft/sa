...
const achievements = [
  ...
  { icon: "🎁", title: "Lucky Streak", desc: "Open 4 Rewards in a single day. Fortune favors you!", tier: "gold", unlocked: false, unlockDate: null, progressText: "0/4 Easy Right?", code: 7 },
  ...
  { icon: "🦂", title: "Monster Hunter", desc: "Defeat A Boss!", tier: "silver", unlocked: false, progressText: "Be Careful...", code: 13 },
  { icon: "🐲", title: "Shadow Hunter", desc: "Defeat An Elite Boss!", tier: "gold", unlocked: false, progressText: "Be...More Careful!", code: 14 },
  { icon: "👹", title: "Sinister Hunter", desc: "Defeat A Legendery Boss!", tier: "platinum", unlocked: false, progressText: "Can you be even More Careful?", code: 15 },
  {icon: "🎭", title: "Blood Museum", desc: "Defeat A 15 Bosses In Total!", tier: "platinum", unlocked: false, progressText: "0/15 Hearts Remain To Kill", code: 16},
  ...
  achievements.forEach(ach => {
    ...
    switch (ach.code) {
      ...
      case 6:
        ...
        break;
      case 7:
        ach.progressText = `${playerState.rewardStreak}/4 Easy Right?`;
        break;
      case 8:
      ...
      case 12:
        ...
        break;
      case 13:
        if (playerState.normalBossDefeated) {
          ach.progressText = "Normal Boss Defeated!";
          }
        break;
      case 14:
        if (playerState.eliteBossDefeated) {
          ach.progressText = "An Elite Boss Defeated";
          }
        break;
      case 15:
        if (playerState.legenderyBossDefeated) {
          ach.progressText = "Woaaa... Legendery!!!";
          }
        break;
      case 16:
        ach.progressText = `${playerState.bossDefeatCount} / 15 Hearts To Kill!`;
        break;
    }
  });
}
