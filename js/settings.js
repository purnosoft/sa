...
const toggle = document.getElementById("toggle_export");
const status = document.getElementById("status_export");
...
toggle.addEventListener("change", () => {
    ...
    setLocalStorage('export_toggle', toggle.checked);

});

let toggled = getLocalStorage('export_toggle');
...
const infoBtn = document.getElementById("exportInfo");
